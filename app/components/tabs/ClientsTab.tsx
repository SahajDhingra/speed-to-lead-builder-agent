      ...
      {showForm && (
        <div className="border border-[#49de80]/30 bg-[#49de80]/5 rounded-xl p-5 space-y-4">
          ...
          <div>
            ...
            <input
              className="w-full border border-gray-300 rounded px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#49de80]/40"
